    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">모든 예약 현황을 확인하고 관리합니다.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          { title: '오늘 예약', value: '24', color: 'blue', icon: FaCalendarAlt },
            ...
            <div key={reservation.id} className="p-6 hover:bg-gray-50 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">{reservation.user}</h3>
