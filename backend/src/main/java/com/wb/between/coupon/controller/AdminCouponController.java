...
import com.wb.between.coupon.service.CouponQueryService;
...
public class AdminCouponController {
    ...
    public String getCouponManagementView(@AuthenticationPrincipal User user,
        ...
        Page<AdminCouponResDto> adminCouponList = couponQueryService.findAdminCouponList(pageable, searchCouponName);
    ...
    public String getEditCouponView(@PathVariable Long cpNo, Model model) {
        ...
        //쿠폰번호로 단일 쿠폰정보 조회
        AdminCouponResDto adminCouponResDto = couponQueryService.findAdminCoupon(cpNo);
